...
<link href="https://fonts.googleapis.com/css2?family=Lobster&display=swap" rel="stylesheet">
    ...
    .form-control{
          ...
          body{
            ...
            /* The image used */
             background-image: url("add_remove_giftcards.jpg");
 ...
 ?>
  <h3 class= "text-center my-4" style="font-family: 'Abril Fatface', cursive; font-size:250%; color:black;">Add gift-card information</h3>
  ...
  <div class="form-group col-md-6">
    <label for="biketype">gift-card Type</label>
    <input type="text" class="form-control" id="biketype" name = "biketype" maxlength = "20">
  </div>
  <div class="form-group col-md-6">
    <label for="bikeno">gift-card id</label>
...
<h3 class= "text-center my-4" style="color: black;">Available gift-card details</h3>
<div class="container my-4">
    ...
    <table class="table" id="myTable">
      <thead>
        <tr>
          <th scope="col" style="color:black">gift-card Photo</th>
          <th scope="col" style="color:black"> Name</th>
          <th scope="col" style="color:black">gift-card name</th>
          <th scope="col" style="color:black">gift-card Type</th>
          <th scope="col" style="color:black">gift-card id</th>
          <th scope="col" style="color:black">Availability</th>
