...
<link href="https://fonts.googleapis.com/css2?family=Lobster&display=swap" rel="stylesheet">
   ...
   body {
          /* The image used */
          background-image: url("log_gift.jpg");
  ...
  <body>
    ...
    <h3 class="text-center"><strong style="font-size:300%;top: 50px; background-color: rgba(11, 3.9, 3.9, 0.7);color: white;">Buy/Sell Gift cards</strong></h3>
