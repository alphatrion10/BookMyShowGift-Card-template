...
<h3 class= "text-center my-4" style="color: black;font-size: 350%;">Your Bookings</h3>
<div class="container my-4">
  ...
  <div id = "reciept-print">
    <table class="table" id="myTable">
      <thead>
        <tr>
          <th scope="col" style="color: black;">giftcard Photo</th>
          ...
          <th scope="col" style="color: black;">giftcard id</th>
